...
type projectItem = {
  ...
  html_url: string;
  description: string;
  openMethod: "_popup" | "_blank";
};
const data: projectItem[] = [
  {
    name: "价值一亿的AI代码",
    html_url: "http://47.122.9.25:5000/",
    description: "价值一亿的AI代码",
    openMethod: "_popup",
  },
  {
    name: "星空科技",
    html_url: "http://47.122.9.25:8089/",
    description: "星空科技 - 创新型网络技术企业",
    openMethod: "_blank",
  },
  {
    name: "opal",
  ...
  },
  {
    ...
    description:
      "Responsive Book Website Design Using Vue3 & vue-i18n & Naive UI",
    openMethod: "_blank",
  },
];
const openUrl = (item: any) => {
  ...
  } else if (item.openMethod === "_popup") {
    window.open(
      item.html_url,
      "",
      "height=529, width=700, top=265,left=645, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no",
    );
  }
};
</script>
      ...
      <div class="container pb-[8em] pt-[3em]">
        ...
        >
          <UCard
            v-for="item in data"
            :key="item['id']"
            class="w-[100%] sm:w-[40%] flex flex-col justify-left item border"
          >
