<template>
  <main class="absolute w-full h-full flex bg-[#fff] pb-[7.5em] px-[10%]">
    ...
    <section class="w-[45%] h-full bg-[#fff] flex items-center justify-end box-border ">
      <img class="rounded-full xl:w-[46%] lg:w-[55%] md:w-[65%] sm:w-[80%]" src="@/assets/images/head.png" alt="head pic"/>
    </section>
  </main>
</template>
