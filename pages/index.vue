<template>
  <main class="absolute w-full h-full flex bg-[#fff] pb-[8em] px-[10%] dark:bg-neutral-900">
    <section class="w-[55%] h-full flex flex-col justify-center box-border text-4xl">
      ...
      <p class="text-xl my-5 dark:text-[#e8e6e3]">You can find me in Twitter: <a target="_blank" class="text-[#0000CD] dark:text-blue-500 no-underline hover:underline" href="https://twitter.com/zhilutianji">@zhilutianji</a>
